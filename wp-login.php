...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	?>
	<div id="login">
        <h1 style="font-family: 'Open Sans'; color: #0e84b5; ">ZESPÓŁ RZECZNIKÓW <br><br>PATENTOWYCH</h1><br>
        <h1 style="font-family: 'Open Sans'; color: #0e84b5; font-weight: lighter;">Website administration panel</h1><br>
